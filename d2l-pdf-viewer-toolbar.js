		...
		<div class="outer-container">
			<div class="toolbar-container">
				...
				<div class="control-container" role="group">
					<d2l-pdf-viewer-toolbar-button active="" id="zoomOutButton" title="[[localize('zoomOutTitle')]]" icon="d2l-tier1:zoom-out" on-tap="_onZoomOutButtonTapped" aria-label="[[localize('zoomOutLabel')]]" aria-disabled="[[_zoomOutButtonDisabled(pageScale, minPageScale)]]">
					</d2l-pdf-viewer-toolbar-button>
					<d2l-pdf-viewer-toolbar-button id="zoomInButton" on-tap="_onZoomInButtonTapped" title="[[localize('zoomInTitle')]]" icon="d2l-tier1:zoom-in" aria-label="[[localize('zoomInLabel')]]" aria-disabled="[[_zoomInButtonDisabled(pageScale, maxPageScale)]]">
					</d2l-pdf-viewer-toolbar-button>
					<d2l-pdf-viewer-toolbar-button toggle="" id="fullscreenButton" on-tap="_onToggleFullscreenButtonTapped" title="[[localize('presentationModeTitle')]]" icon="[[_getFullscreenIcon(isFullscreen)]]" aria-label="[[localize('presentationModeLabel')]]" pressed="[[isFullscreen]]" disabled="[[!fullscreenAvailable]]">
					</d2l-pdf-viewer-toolbar-button>
				</div>
			</div>
		</div>
